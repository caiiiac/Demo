 ...
 */
- (id)initWithMapView:(MAMapView *)mapView delegate:(id<AMapNaviViewControllerDelegate>)delegate;
 ...
 */
@property (nonatomic, assign) id<AMapNaviViewControllerDelegate> delegate;
...
/*!
 @brief 导航界面关闭按钮点击时的回调函数
 */
- (void)AMapNaviViewControllerCloseButtonClicked:(AMapNaviViewController *)naviViewController __attribute__ ((deprecated("use - (void)naviViewControllerCloseButtonClicked:(AMapNaviViewController *)naviViewController instead")));

/*!
 @brief 导航界面更多按钮点击时的回调函数
 */
- (void)AMapNaviViewControllerMoreButtonClicked:(AMapNaviViewController *)naviViewController __attribute__ ((deprecated("use - (void)naviViewControllerMoreButtonClicked:(AMapNaviViewController *)naviViewController instead")));

/*!
 @brief 导航界面转向指示View点击时的回调函数
 */
- (void)AMapNaviViewControllerTrunIndicatorViewTapped:(AMapNaviViewController *)naviViewController __attribute__ ((deprecated("use - (void)naviViewControllerTurnIndicatorViewTapped:(AMapNaviViewController *)naviViewController instead")));
